...
var _b = require('./localization'), t = _b.t, ct = _b.ct, findTranslations = _b.findTranslations, setTranslations = _b.setTranslations, setTranslationsWithContext = _b.setTranslationsWithContext;
